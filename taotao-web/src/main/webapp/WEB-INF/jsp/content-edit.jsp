...
<link href="/taotao-web/js/kindeditor-4.1.10/themes/default/default.css" type="text/css" rel="stylesheet">
<script type="text/javascript" charset="utf-8" src="/taotao-web/js/kindeditor-4.1.10/kindeditor-all-min.js"></script>
<script type="text/javascript" charset="utf-8" src="/taotao-web/js/kindeditor-4.1.10/lang/zh_CN.js"></script>
...
var contentEditPage = {
		submitForm : function(){
			...
			$.post("/taotao-web/content/edit",$("#contentEditForm").serialize(), function(data){
				if(data.status == 200){
					console.log(data);
					alert('新增内容成功!');
