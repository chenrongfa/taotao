...
!function() {
    ...
    a.fn.Jlazyload = function(b, c) {
        if (this.length) {
            var d, e, f = a.extend({type: null,offsetParent: null,source: "data-lazyload",placeholderImage: "/taotao-portal/images/blank.gif",placeholderClass: "loading-style2",threshold: 200}, b || {}), g = this, h = function(a) {
...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		// 
		URL_Serv:"http://127.0.0.1:8081/taotao-rest/itemcat/all?callback=category.getDataService",
		// URL_Serv: "http://127.0.0.1:8082/taotao-portal/category.json",
		//URL_Serv: "http://127.0.0.1:8081/taotao-rest/category.json",
