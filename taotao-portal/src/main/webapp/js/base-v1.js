...
function login() {
	alert('b')
    location.href = "http://localhost:8083/taotao-sso/login?redirect="+location.href;
}
function regist() {
    return location.href = "http://localhost:8083/taotao-sso/register";
}
...
function search(a) {
    var b = "http://localhost:8082/taotao-portal/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
    ...
    for (var b = a.getElementsByTagName("img"), c = 0; c < b.length; c++)
        b[c].onerror = function() {
            ...
            if (b) {
                ...
                this.src = "/taotao-portal/images/blank.gif", this.className = a
            }
        }
    ...
    for (var h = 0; h < e.length; h++)
        d = this.FN_GetCompatibleData(e[h]), f.push('<div class="fore'), f.push(h + 1), f.push('" width="'), f.push(d.width), f.push('" height="'), f.push(d.height), f.push('"><a target="_blank" href="'), f.push(d.href), f.push('" title="'), f.push(d.alt), f.push('"><img src="'), 0 == h ? f.push(d.src) : (f.push('/taotao-portal/images/blank.gif" style="background:url('), f.push(d.src), f.push(") no-repeat center 0;")), f.push('" width="'), f.push(d.width), f.push('" height="'), f.push(d.height), f.push('" /></a></div>');
