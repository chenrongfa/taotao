...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/base-v1.js" charset="utf-8"></script>
<!--shortcut start-->
	...
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld">
			<a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img
				src="<%=request.getContextPath()%>/images/taotao-logo.gif"
				width="270" height="60" alt="淘淘"></a>
		</div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld">
					<s></s><a href="http://localhost:8084/taotao-portal/user/showLogin"
						clstag="homepage|keycount|home2012|04a">我的淘淘</a><b></b>
				</dt>
				<dd>
			...
			<dl>
				<dt class="ld">
					<s></s><span class="shopping"><span id="shopping-amount"></span></span><a
						href="/taotao-portal/item/cart.html" id="settleup-url">去购物车结算</a> <b></b>
				</dt>
				<!-- 				<dd>
					<div class="prompt">
