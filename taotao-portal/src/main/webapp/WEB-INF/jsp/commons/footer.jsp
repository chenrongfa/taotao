...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-extend.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/taotao.js" charset="utf-8"></script>
