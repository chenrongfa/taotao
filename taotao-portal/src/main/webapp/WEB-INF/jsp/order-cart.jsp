...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <link type="text/css" rel="stylesheet"  href="/taotao-portal/css/order-commons.css" source="widget"/>	
	<script type="text/javascript" src="/taotao-portal/js/jquery-1.6.4.js"></script>
	<script type="text/javascript" src="/taotao-portal/js/base.js"></script>	
	<script type="text/javascript" src="/taotao-portal/js/order.common.js"></script>
	<script type="text/javascript" src="/taotao-portal/js/jquery.checkout.js"></script>
</head>	<body id="mainframe">
<jsp:include page="commons/shortcut.jsp" />
<!--shortcut end-->

<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/taotao-portal/images/taotao-logo.gif" alt="淘淘商城"></a></div>
</div>

<form id="orderForm" class="hide" action="/taotao-portal/order/create.html" method="post">
